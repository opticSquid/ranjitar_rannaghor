...
CREATE INDEX IF NOT EXISTS idx_mph_item_eff_desc
    ON public.meal_price_history USING btree
    (item_id COLLATE pg_catalog."default" ASC NULLS LAST, effective_from DESC NULLS FIRST)
    TABLESPACE pg_default;
END;
